...
export default function Home({
  ...
  const incomeUSD = clients
    ...
    .reduce((s, x) => s + x, 0);
  const totalIncome = incomeARS + incomeUSD * rate;
  ...
  return (
    ...
    >
      ...
      {demoMode && (
        <div
          style={{
            background: "linear-gradient(90deg,#C8956C,#8B6F9E)",
            padding: "8px 17px",
            display: "flex",
        ...
        >
          <p style={{ color: "#fff", fontSize: 12, fontWeight: 600 }}>
            👀 Estás viendo el modo demo — los cambios no se guardan
          </p>
      ...
      >
        ...
        >
          ...
          >
            ...
            {salesTotal > 0 && (
              <p style={{ fontSize: 9, color: "#8B7355", marginTop: 2 }}>
                🛒 {fmt(salesTotal)} ventas directas
              </p>
            )}
          </div>
        </div>
